...
VboxManage storageattach porteus_browser_appliance --storagectl porteus_live_cd --type dvddrive --port 1 --device 0 --medium "%~dp0porteus-browser-appliance.iso" --tempeject on
